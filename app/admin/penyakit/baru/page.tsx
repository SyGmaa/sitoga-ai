  ...
  return (
    <div className="flex flex-col gap-8 animate-[slide-up_0.5s_ease-out_forwards]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Add New Ailment</h2>
          <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Create a new disease or symptom for the AI to diagnose.</p>
        </div>
          ...
          <div className="bg-white/40 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 rounded-xl p-6">
             ...
             <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400">
               <li className="flex gap-2">
                 ...
                 The ailment name should be specific as it will be matched during AI Diagnosis.
               </li>
               <li className="flex gap-2">
                 <span className="material-symbols-outlined text-primary text-sm mt-0.5">check_circle</span>
