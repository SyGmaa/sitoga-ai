...
interface TambahPenyakitFormProps {
...
/* ================================================================
   Main Form
   ================================================================ */
export function TambahPenyakitForm({ gejalaList, tanamanList }: TambahPenyakitFormProps) {
  ...
  // Helper: get flat list of selected gejala IDs for the MultiSelect
      ...
      <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input required name="nama" id="nama" placeholder="e.g. Asam Urat, Demam, Batuk Berdahak" type="text" className={inputClass} />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea name="deskripsi" id="deskripsi" placeholder="Deskripsi mengenai penyakit ini..." rows={4} className={inputClass}></textarea>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-medium text-slate-400 bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-full">Opsional</span>
          </div>
          ...
          <MultiSelect
            ...
            emptyLabel="Belum ada data gejala di database."
            accentColor="#1f8825"
            accentColorLight="#4ade80"
            icon="symptoms"
          />

          {/* Per-gejala settings: isGejalaWajib & bobotGejala */}
        ...
        <div className="flex flex-col gap-4">
          ...
          <MultiSelect
            ...
            emptyLabel="Belum ada data tanaman di database."
            accentColor="#059669"
        ...
        <div className="flex justify-end pt-2">
          ...
          >
            ...
            {isPending ? 'Menyimpan...' : 'Simpan Penyakit'}
          </button>
        </div>
      </form>
    </>
