    ...
    <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark font-sans text-slate-900 dark:text-slate-100 selection:bg-primary selection:text-background-dark">
      ...
      <nav className="hidden md:flex w-[280px] flex-col border-r border-slate-200 dark:border-[#234829]/50 bg-[#ebf1ec] dark:bg-background-dark h-full relative z-20">
        ...
        <div className="flex-1 overflow-y-auto px-2 space-y-1">
          <button onClick={() => setMessages([{ id: "sys1", role: "assistant", content: "Hello! I am your botanical health assistant. Describe your symptoms or ask about specific plants in our Campus Garden." }])} className="w-full text-left flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-[#234829]/10 dark:hover:bg-[#234829]/20 text-[#3a7544] dark:text-[#92c99b] transition-colors">
            ...
            {isLoading && object && (
              <div className="flex gap-4 items-start animate-[fadeIn_0.5s_ease-out]">
                ...
                <div className="flex flex-col gap-2 max-w-[85%] lg:max-w-[70%]">
                  ...
                  <div className="p-5 rounded-2xl leading-relaxed shadow-sm flex flex-col gap-3 bg-white dark:bg-surface-dark/80 border border-slate-200 dark:border-[#234829] rounded-tl-none text-slate-800 dark:text-slate-200">
