  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col group/design-root">
      ...
      <main className="flex-1 flex flex-col items-center w-full bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display">
        <div className="w-full max-w-7xl px-4 md:px-10 py-8 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pt-4">
            ...
            {plants.length === 0 && (
              <div className="col-span-full py-12 text-center text-slate-500 dark:text-slate-400 italic font-medium">
      ...
      <div className="fixed bottom-24 md:bottom-6 right-6 z-50">
        <Link
          href="/scan"
          className="flex items-center justify-center size-14 rounded-full bg-primary text-background-dark shadow-[0_4px_20px_rgba(19,236,55,0.4)] hover:scale-110 transition-transform cursor-pointer"
        >
